...
public class EmployeeBST {
	...
	private boolean find(Employee x, Node n) {
		...
		if (n != null && n.element.equals(x))
			return true;
		return (com.compare(x, n.element) < 0) ? find(x, n.left) : find(x, n.right);
	...
	public void insert(Employee x) {
		if (root == null) {
			...
			while (!inserted) {
				...
				else if (com.compare(x, n.element) >= 0) {
...
//		}
	...
	static class BTreePrinter {
		...
		static boolean isAllElementsNull(List<Node> list) {
