...
public class MyHashtable implements Iterable {
	...
	static MyHashtable h;
	static MyHashtable temp;
	static {
		INITIAL_SIZE = 20;
	}
	...
	private void rehash() {
		temp = new MyHashtable(tableSize * 2);

		Iterator it = h.iterator();
		while (it.hasNext()) {
			Entry e = (Entry) getEntry(it.next());
	...
	public static void main(String[] args) {
		...
		System.out.println("num of Entries : " + h.numEntries);
		System.out.println("load Factor : " + h.loadFactor());
		for (int i = 50; i < 100; ++i) {
			h.put(i, i);
		}
		System.out.println("teble size : " + h.tableSize);
		System.out.println("num of Entries : " + h.numEntries);
		System.out.println("load Factor : " + h.loadFactor());
		for (int i = 50; i < 75; ++i) {
			h.put(i, i);
